...
export const RESOLUTION_HINTS: Record<IssueCode, string> = {
  ...
  MIGRATION_UNAVAILABLE: '이 파일을 만든 버전에서 열어 다시 내보냅니다.',
  MIGRATION_FAILED: '원본은 그대로입니다. 다른 사본으로 다시 시도합니다.',
  INVALID_JSON: '파일이 손상됐습니다. 다른 사본을 씁니다.',
  NOT_AN_OBJECT: 'HowSheet에서 내보낸 .howsheet.json 파일을 고릅니다.',
  ASSET_DATA_MISSING: '가져온 뒤 이미지를 다시 넣습니다.',
  ASSET_DATA_MALFORMED: '파일이 손상됐습니다. 다른 사본을 씁니다.',
  ASSET_CHECKSUM_MISMATCH: '내보낸 원본 파일을 다시 받아 가져옵니다.',
  ASSET_CHECKSUM_UNVERIFIED: 'https 또는 localhost에서 열면 확인할 수 있습니다.',
  ASSET_MIME_MISMATCH: '가져온 뒤 이미지를 다시 넣습니다.',
  ASSET_DATA_ORPHANED: '조치할 것이 없습니다. 쓰이지 않는 이미지입니다.',
